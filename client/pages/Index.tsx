...
function getKpis(filteredProjects: Project[]) {
  ...
  return [
    ...
    { label: "Pending Verification", value: totals.pending.toLocaleString(), detail: "Reports awaiting REA review", icon: Clock3, tone: "pending", action: "Inspections" },
  ];
}
