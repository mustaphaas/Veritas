        ...
        <div className="mx-auto max-w-[1580px] px-4 py-0 sm:px-7 lg:px-7">
          ...
          <div className="mt-4 grid items-start gap-4">
            <section className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
              ...
              <div className={selectedSummary ? "compact-map-row grid lg:h-[320px] lg:grid-cols-[minmax(0,1fr)_290px]" : "grid"}>
                <div ref={mapContainerRef} className="relative min-h-[320px] overflow-hidden bg-[#f7fbf8] sm:h-[320px]" onWheel={(event) => { event.preventDefault(); setMapZoom((zoom) => Math.min(2.5, Math.max(1, zoom + (event.deltaY < 0 ? 0.15 : -0.15)))); }}>
                  ...
                  <svg className="relative z-10 h-full min-h-[320px] w-full touch-pan-x touch-pan-y sm:min-h-0" viewBox="0 0 650 300" fill="none" aria-label={`Interactive Nigeria state map viewed by ${mapMode}`}>
