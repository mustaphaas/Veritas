    ...
    <div className="min-h-screen bg-[#f6f8f6] text-slate-900">
      ...
      <main className="lg:pl-[190px]">
        ...
        <div className="mx-auto max-w-[1580px] px-4 py-0 sm:px-7 lg:px-7">
          ...
          {!["Claims","Consultants","Analytics","Reports"].includes(activeNav) && <footer className="mt-8 -mx-4 flex flex-col gap-3 border-t border-[#d6e9da] bg-[#f0fbf5] px-4 py-5 sm:-mx-7 sm:flex-row sm:items-center sm:justify-between sm:px-7 lg:-mx-9 lg:px-9"><div className="flex items-center gap-3"><div className="relative h-10 w-12 overflow-hidden" aria-hidden="true"><div className="absolute left-1 top-1 h-8 w-9 -skew-x-12 rounded-[45%_55%_45%_55%] bg-[#79c893]" /><div className="absolute left-2 top-2 h-6 w-8 -skew-x-12 rounded-[45%_55%_45%_55%] bg-[#a7dfb8]" /></div><div><p className="text-base font-bold tracking-[0.12em] text-[#075c33]">REA</p><p className="text-[11px] text-slate-500">Reliable power. Stronger communities. A brighter Nigeria.</p></div></div><p className="flex items-center gap-2 text-xs text-slate-500"><Clock3 className="h-4 w-4 text-[#08733f]" />Last updated: Today, 4:07 AM</p></footer>}
        </div>
      </main>
    </div>
  );
