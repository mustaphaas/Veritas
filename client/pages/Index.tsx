  ...
  return (
    <div className="min-h-screen bg-[#f6f8f6] text-slate-900">
      <main>
        ...
        <nav className="border-b border-slate-200 bg-white" aria-label="REA dashboard navigation">
          <div className="mx-auto flex max-w-[1580px] items-center gap-1 overflow-x-auto px-4 sm:px-7 lg:px-7">
