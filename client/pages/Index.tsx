...
function getKpis(filters: Filters) {
  ...
  return [
    { label: "Programs", value: selectedCount ? "1" : "3", detail: "National portfolio", icon: Building2, highlighted: false },
    ...
    { label: "Verified inspections", value: `${Math.round(66.7 * factor)}%`, detail: `${format(84)} inspections verified`, icon: CheckCircle2, highlighted: false },
  ];
}
