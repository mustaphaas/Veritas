...
export default function ReaUserManagement() {
  ...
  <div className="flex min-w-[220px] flex-wrap items-center gap-1.5">
    ...
    <button type="button" onClick={()=>void deleteUser(user)} className="rounded-md border border-rose-200 bg-rose-50 px-2 py-1.5 text-[10px] font-semibold text-rose-700 hover:bg-rose-100">Delete</button>
  </div>
