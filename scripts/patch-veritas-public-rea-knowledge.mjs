...
s = s.replace(/const BUILD_ID = "[^"]+";/, 'const BUILD_ID = "veritas-2026-09-11-public-rea-knowledge-r1";');
...
console.log('Applied official REA public knowledge routing');
